...
void Modules::insertModule(uint8_t module) {
  ...
  switch (module) {
    case 1: {
        ...
        analogWrite(MODULE_PWM_LEFT_PIN, MODULE_CHANGE_SPEED);
    ...
    case 2: {
        ...
        analogWrite(MODULE_PWM_RIGHT_PIN, MODULE_CHANGE_SPEED);
          ...
          case Start: {
              ...
              switch (moduleType[0]) {
                ...
                case Motor: {
                    //Direction
                    // pinMode(MODULE_FUNC_1_ANALOG_PIN, OUTPUT);
                    digitalWrite(MODULE_FUNC_1_ANALOG_PIN, HIGH);
