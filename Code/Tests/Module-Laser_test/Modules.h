...
#define MODULE_FUNC_1_PWM_PIN          21
#define MODULE_FUNC_1_TYPE_PIN         17
#define MODULE_FUNC_1_STATE_PIN         1

#define MODULE_FUNC_2_ANALOG_PIN      A11
#define MODULE_FUNC_2_PWM_PIN          20
#define MODULE_FUNC_2_TYPE_PIN         16
#define MODULE_FUNC_2_STATE_PIN         0




#define MODULE_TYPE_VALUE_BATTERY 120
#define MODULE_TYPE_VALUE_MOTOR 790
#define MODULE_TYPE_VALUE_LASER 950//670//520//9250 //967
#define MODULE_TYPE_VALUE_EMPTY 122

#define MODULE_TYPE_VALUE_MAX_DELTA 80
...
class Modules {
  public:
    ...
    void requestChangeAction(uint8_t moduel, ModuleChangeAction action);
